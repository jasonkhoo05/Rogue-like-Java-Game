...
public interface Behaviour {
	...
	/**
	 * An interface for creating actions. Chaining these together can result in an actor performing more complex tasks.
	 *
	 ...
	 * us to modularise the code that decides what to do, and that means that it can be
	 ...
	 */
	Action generateAction(Actor actor, GameMap map);
}
